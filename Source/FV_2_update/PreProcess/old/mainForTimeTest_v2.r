...
cat(file=paste(TimeLog, '/timeLogComp', Ext, sep=''),append=TRUE,'main_v2:twoClass:time used for sfExport: ', timeUsed, '\n')
...
cat(file=paste(TimeLog, '/timeLogComp', Ext, sep=''),append=TRUE,'main_v2.R:twoClass:simulation', simu1, ':', simu2,'time used for simulation parallel: ', timeUsed, '\n')
