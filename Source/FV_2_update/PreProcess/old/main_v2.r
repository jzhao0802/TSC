...
dictFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/CodesDrugsDict"

TSCTsIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/TSCTestIndices"
TSCTrIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/TSCTrIndices"
TSCVlIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/TSCVlIndices"

TsIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/TestIndices"
TrIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/TrIndices"
VlIndexFile <- "D:/jzhao/RareDisease_TSC/01. Data/Dict_Ind_2/1n/VlIndices"

TrFile1 <- "D:/jzhao/RareDisease_TSC/01. Data/FV_2/1n/trainv"
VlFile <- "D:/jzhao/RareDisease_TSC/01. Data/FV_2/1n/valid"
TrFile <- "D:/jzhao/RareDisease_TSC/01. Data/FV_2/1n/train"
TsFilePos <- "D:/jzhao/RareDisease_TSC/01. Data/FV_2/1n/testpos"
TsFileNeg <- "D:/jzhao/RareDisease_TSC/01. Data/FV_2/1n/testneg"
TimeLog <-  "D:/jzhao/RareDisease_TSC/01. Data"
Ext <- ".csv"
...
sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/jzhao/RareDisease_TSC/01. Data/parOnSimu.log")
sfLibrary(snowfall)
timeStart <- proc.time()
...
cat(file=paste(TimeLog, '/timeLog_v2', Ext, sep=''),append=TRUE,'oneClass:time used for sfExport: ', proc.time()-timeStart, '\n')
...
cat(file=paste(TimeLog, '/timeLog_v2', Ext, sep=''),append=TRUE,'oneClass:time used for simulation parallel: ', timeUsed, '\n')
