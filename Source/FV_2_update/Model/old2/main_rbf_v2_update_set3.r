...
AvgRsFile <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Rs/rbf/AvgResFile"
RsFileVl <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Rs/rbf/ResVlFile"
Ext <- '.csv'
...
sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/logModel_binary_rbf_parOnSimAll.txt")
sfLibrary(snowfall)
...
TimeLog <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Rs/rbf"
...
parOnSim <- function(counter) {
  ...
  TSCIndexFile  <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Indices/rbf/ProspectiveTSC"
  ConTSCIndexFile  <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Indices/rbf/ConfirmedTSC"
  
  ModelFile <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Model/rbf/SVModel"
  
  TrVlTsRsFile <- "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/Rs/rbf/TrVlTsResFile"
  ...
  if (PARALLEL) {
    num_pros <- Sys.getenv('NUMBER_OF_PROCESSORS')
    sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/logModel_binary_rbfKernel_parOnSim.txt")
    sfLibrary(snowfall)
  }
  ...
  #pdf(file=paste('D:/RareDisease_TSC/Results/FV_2_update/2n_rbf_setting3_maxPPV/recall-precision-curve', '.pdf', sep=''), width=11, height=20)
  #par(mfrow=c(5,2))
...
plotf <- function(data){
	pdf(file=paste('D:/RareDisease_TSC/Results/FV_2_update/2n_lin/recall-precision-curve_simulation_', data, '.pdf', sep=''))
  par(mfrow=c(5,2))
  par(cex.main=1.3, cex.lab=1.2, cex.axis=1)
  nonTSCNum <- 70000
if(data=='Vl'){
