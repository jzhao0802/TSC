...
##################################################################################################
 ...
 # Source files
  ...
  sfSource("D:/Hui/TSC project/Source/Model/FV_3/InvkSVM.R")
  sfSource("D:/Hui/TSC project/Source/Model/FV_3/PredSVM.R")
...
AvgRsFile <- "D:/jzhao/RareDisease_TSC/03. Output/FV_3/2n/Rs/rbf/AvgResFile"
Ext <- '.csv'
AvgRsFile <- paste(AvgRsFile,Ext,sep="")  

num_pros <- Sys.getenv('NUMBER_OF_PROCESSORS')
sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/jzhao/RareDisease_TSC/03. Output/FV_3/logModel_binary_rbf_parOnSimAll.txt")
sfLibrary(snowfall)
...
parOnSim <- function(counter) {
  TrFile1 <- "D:/RareDisease_TSC/Data/FV_3/2n/trainv"
  TrFile <- "D:/RareDisease_TSC/Data/FV_3/2n/train"
  VlFile <- "D:/RareDisease_TSC/Data/FV_3/2n/valid"
  TsFilePos <- "D:/RareDisease_TSC/Data/FV_3/2n/testpos"
  TsFileNeg <- "D:/RareDisease_TSC/Data/FV_3/2n/testneg"
  
  # Output file (Index and result files)  
  
  TSCIndexFile  <- "D:/jzhao/RareDisease_TSC/03. Output/FV_3/2n/Indices/rbf/ProspectiveTSC"
  ConTSCIndexFile  <- "D:/jzhao/RareDisease_TSC/03. Output/FV_3/2n/Indices/rbf/ConfirmedTSC"
  
  ModelFile <- "D:/jzhao/RareDisease_TSC/03. Output/FV_3/2n/Model/rbf/SVModel"
  
  TrVlTsRsFile <- "D:/jzhao/RareDisease_TSC/03. Output/FV_3/2n/Rs/rbf/TrVlTsResFile"
  ...
  if (PARALLEL) {
    num_pros <- Sys.getenv('NUMBER_OF_PROCESSORS')
    sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/jzhao/RareDisease_TSC/03. Output/FV_3/logModel_binary_rbf_parOnSim.txt")
    sfLibrary(snowfall)
  }
