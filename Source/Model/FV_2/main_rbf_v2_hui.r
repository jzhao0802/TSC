...
path1 <- "D:/RareDisease_TSC/Results/FV_2/2n_rbf_"
model_num <- 'model1_v3'
...
sfSource("D:/RareDisease_TSC/Source/Model/FV_2/InvkSVM_rbf_model1_v2.R")
...
sfLibrary(snowfall)
sfExport('ResMat', 'PARALLEL', 'ONE','ThreshLim', 'kertype', 'InvkSVM','PredSVM', 'Ext','pathOutput','limitDr')
    sfClusterEval(library("e1071"))
...
parOnSim <- function(counter) {
  ...
  sfExport("svm_model","PredSVM","TsFileNeg","TSCIndexFile","Ext",'pathOutput','limitDr')  
