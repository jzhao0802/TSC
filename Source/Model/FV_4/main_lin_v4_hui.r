...
pathOutput <- "D:/RareDisease_TSC/Results/FV_4/2n_lin"
...
dir.create(path=paste(pathOutput, c('Indices', 'Model', 'Rs')[3], 'lin', sep='/'), recursive=T, showWarnings=T)
 ...
 # Source files
  ...
  sfSource("D:/RareDisease_TSC/Source/Model/FV_4/InvkSVM_v4_hui.R")
  sfSource("D:/RareDisease_TSC/Source/Model/FV_4/PredSVM.R")
...
parOnSim <- function(counter) {
  TrFile1 <- "D:/RareDisease_TSC/Data/FV_4/2n/trainv"
  TrFile <- "D:/RareDisease_TSC/Data/FV_4/2n/train"
  VlFile <- "D:/RareDisease_TSC/Data/FV_4/2n/valid"
  TsFilePos <- "D:/RareDisease_TSC/Data/FV_4/2n/testpos"
  TsFileNeg <- "D:/RareDisease_TSC/Data/FV_4/2n/testneg"
