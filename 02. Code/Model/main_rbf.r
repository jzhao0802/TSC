...
################################################################################################## 
 ...
 # Model Building and Identificaton of TSC
  ...
  # Output file (Index and result files)  
    ...
    TSCIndexFile  <- "D:/RareDisease_TSC/Results/FV_3/2n/Indices/rbf/ProspectiveTSC"
    ConTSCIndexFile  <- "D:/RareDisease_TSC/Results/FV_3/2n/Indices/rbf/ConfirmedTSC"

    ModelFile <- "D:/RareDisease_TSC/Results/FV_3/2n/Model/rbf/SVModel"
  
    TrVlTsRsFile <- "D:/RareDisease_TSC/Results/FV_3/2n/Rs/rbf/TrVlTsResFile"
    AvgRsFile <- "D:/RareDisease_TSC/Results/FV_3/2n/Rs/rbf/AvgResFile"
 ...
 # Save scores in a file
  ...
  # Read negative (non-TSC) test data and Evaluate model 
    ...
    if (PARALLEL) {
      ...
      sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/jzhao/RareDisease_TSC/03. Output/FV_3/logModel_binary_rbf.txt")
      sfLibrary(snowfall)
    }
