...
#the function parameters have been changed
PrsTst <- function(innerloop, IdxAry, Dict, NonTSCAgeGender, NonTSCCodeDrug, MeanAgeFirst, MeanAgeSecond, TsFilePos, TsFileNeg, filenum, TsIndexFile, Ext, norm2) {
