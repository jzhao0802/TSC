...
sfSource('D:/jzhao/RareDisease_TSC/02. Code/PreProcess/SampAndRes_forParOnSimu.R')
...
sfSource('D:/jzhao/RareDisease_TSC/02. Code/PreProcess/PrsTst_forTest.R')
...
dictFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/CodesDrugsDict"

TSCTsIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/TSCTestIndices"
TSCTrIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/TSCTrIndices"
TSCVlIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/TSCVlIndices"

TsIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/TestIndices"
TrIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/TrIndices"
VlIndexFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/Dict_Ind_2/2n/VlIndices"

TrFile1 <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n/trainv"
VlFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n/valid"
TrFile <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n/train"
TsFilePos <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n/testpos"
TsFileNeg <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n/testneg"
TimeLog <- "D:/jzhao/Jie/RareDisease_TSC/01. Data/FV_2/2n"
...
sfInit(parallel=TRUE, cpus=num_pros, type="SOCK",slaveOutfile = "D:/jzhao/Jie/RareDisease_TSC/01. Data/parOnSimu.log")
sfLibrary(snowfall)
timeStart <- proc.time()
...
timeUsed <- proc.time()-timeStart
cat('time used for sfExport: ', proc.time()-timeStart, '\n')
cat(file=paste(TimeLog, '/timeLogComp', Ext, sep=''),append=TRUE,'main_v3:twoClass:time used for sfExport: ', timeUsed, '\n')
...
simu2 <- 10
timeStart <- proc.time()
result <- sfClusterApplyLB( simu1:simu2, runBySimu)
timeEnd <- proc.time()
timeUsed <- timeEnd-timeStart
cat(file=paste(TimeLog, '/timeLogComp', Ext, sep=''),append=TRUE,'main_v3.R:twoClass:simulation', simu1, ':', simu2,'time used for simulation parallel: ', timeUsed, '\n')
